...
def evaluate_compliance(event, configuration_item, valid_rule_parameters):
	...
	print("CheckUninstalledApplications v1") 
	print("Resource Id: ", configuration_item["configuration"])
	print("Parameters: ", valid_rule_parameters)

	whitelistedApps = valid_rule_parameters["WhitelistedApps"].split(",")

	print("WhitelistedApps: ", whitelistedApps)
	...
	for whitelisted in whitelistedApps:
		if whitelisted in installed_packages:
			compliant = True
		else:
			compliant = False
			break
	...
	if compliant:
		...
		with open('/tmp/WantedApplications.json', 'w') as file:
			json.dump(mydict, file)

		s3_client.upload_file('/tmp/WantedApplications.json', 'my-key-bucket-rodri', 'WantedApplications.json')
